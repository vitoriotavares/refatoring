...
describe('main', () => {
    it('#statement', () => {
        ...
        expect(result.replace(/\s/g, '')).toEqual('StatementforBigCoHamlet:$650.00(55seats)AsYouLikeIt:$580.00(35seats)Othello:$500.00(40seats)Amountowedis173000Youearned47credits');
    })
})